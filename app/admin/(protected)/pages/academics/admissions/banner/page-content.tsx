  ...
  const fetchBanner = async () => {
    try {
      ...
      if (response.ok) {
        ...
        if (data) {
          setBanner(data)
          setImageUrl(data.banner_image_url || '')
        }
      }
    } catch (error) {
    ...
    try {
      if (banner) {
        const response = await fetch(`/api/admin/admissions/banner-settings/${banner.id}`, {
          ...
          body: JSON.stringify({ banner_image_url: imageUrl }),
        })
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-4 md:p-8">
      <div className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-gray-600 dark:text-gray-400">Manage the admissions page banner image</p>
        </div>
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <div className="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
                  <AdmissionsBanner backgroundImageUrl={imageUrl || '/banner.jpg'} />
                </div>
              </div>
