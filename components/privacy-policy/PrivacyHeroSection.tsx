...
export default function PrivacyHeroSection({
  ...
  description = 'How we protect and use your information at Mandaluyong College of Science and Technology',
  icon = 'ShieldCheck',
}: PrivacyHeroProps) {
  // Get the Lucide icon component, fallback to ShieldCheck
  const IconComponent = (LucideIcons as any)[icon] || LucideIcons.ShieldCheck
