...
export default function LatestAnnouncements() {
  ...
  return (
    <section className="w-full py-12 bg-whitee">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {announcements.map((announcement) => (
            <div
              key={announcement.id}
              className="border border-gray-200 rounded-lg overflow-hidden bg-white hover:border-gray-300 transition-colors cursor-pointer group"
            >
              {/* Image Container */}
              ...
              <div className="p-6 flex justify-between items-start">
                ...
                <ChevronRight className="w-5 h-5 text-gray-400 group-hover:text-gray-600 transition-colors ml-3 flex-shrink-0 mt-1" />
              </div>
            </div>
          ))}
        </div>
