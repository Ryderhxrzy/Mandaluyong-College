    ...
    <footer className="bg-slate-900 text-gray-400">
      ...
      <div className="w-full max-w-[1400px] mx-auto px-8 md:px-16 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-white font-bold text-base">MCST</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link href="/admissions" className="text-gray-400 hover:text-white transition">
                  Apply
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/academics" className="text-gray-400 hover:text-white transition">
                  Programs
                </Link>
              </li>
              <li>
          ...
          <div>
            <h3 className="text-white font-bold text-base mb-6">Student Resources</h3>
            <ul className="space-y-3 text-sm">
              <li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li className="flex gap-3">
                ...
                <span className="text-gray-400">(02) 87160352</span>
              </li>
              <li className="flex gap-3">
                <Mail size={18} className="flex-shrink-0 text-gray-400" />
                <span className="text-gray-400">registrarsoffice@mcst.edu.ph</span>
              </li>
        ...
        <div className="flex flex-col justify-center items-center gap-4">
          <p className="text-sm text-gray-500">&copy; 2026 MCST. All rights reserved.</p>
